...
function ApplicationTime() {
  ...
  return (
    <div className="flex flex-col col-span-12 sm:col-span-8 bg-white dark:bg-slate-800 shadow-lg border border-slate-200 dark:border-slate-700 h-[600px]">
      ...
      <div className="grow">
        ...
        {labels && <LineChart data={chartData} width={389} height={300} />}
      </div>
    </div>
  );
}
